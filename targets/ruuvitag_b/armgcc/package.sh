...
nrfutil settings generate --family NRF52 --application _build/nrf52832_xxaa.hex --application-version 1  --bootloader-version 2 --bl-settings-version 2 --key-file ruuvi_open_private.pem --sd-boot-validation VALIDATE_ECDSA_P256_SHA256 --softdevice ../../../../nRF5_SDK_15.3.0_59ac345/components/softdevice/s132/hex/s132_nrf52_6.1.1_softdevice.hex --app-boot-validation VALIDATE_ECDSA_P256_SHA256 settings.hex
...
nrfutil pkg generate --application _build/nrf52832_xxaa.hex --application-version 1 --hw-version 0xB0 --sd-req 0xB7 --key-file ruuvi_open_private.pem ${BINNAME}\_app_dfu.zip --app-boot-validation VALIDATE_ECDSA_P256_SHA256 
